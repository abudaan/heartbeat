...
//		console.log(listenerIds,eventId,event)
...
*/
	...
	getEvents = function(type, data){
		...
		if(dataType === 'array'){
			for(i = data.length - 1; i >= 0; i--){
				e = data[i];
				if(type === 'event' && e.className !== 'MidiEvent'){
					console.warn('skipping', e, 'because it is not a MidiEvent');
					continue;
			...
			if(type === 'event'){
				if(data.className !== 'MidiEvent'){
					console.error(data, ' is not a MidiEvent');
					return -1;
				}else{
					events = [data];
				}
...
*/
    ...
    //if(sequencer.os === 'ios' || (sequencer.os === 'osx' && sequencer.browser === 'safari')){
    if(sequencer.browser === 'safari'){
        // safari supports only mp3
        ...
        sequencer.addSamplePack({
            ...
            folder: 'heartbeat',
            mapping: {
                'hightick': '',
                'lowtick': ''
            }
        });
    }
...
/*
    ...
    sequencer.addSamplePack({
        ...
        folder: 'heartbeat',
        mapping: {
            'hightick': '',
            'lowtick': ''
        }
    });
*/
